...
%>
    ...
    <div id="container2">
		...
		<%
			...
			String jsql = "select orders_products.pid, products.name, products.imgPath, count(*) from orders_products left join products on orders_products.pid=products.pid group by pid order by count(*) desc";   
